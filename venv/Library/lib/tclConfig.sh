...
# installed.
TCL_PREFIX='I:/Python_E2EML/E2EML_LinearRegression_California_House/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='I:/Python_E2EML/E2EML_LinearRegression_California_House/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='I:/Python_E2EML/E2EML_LinearRegression_California_House/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-II:/Python_E2EML/E2EML_LinearRegression_California_House/venv\Library\include'
...
TCL_PACKAGE_PATH='I:/Python_E2EML/E2EML_LinearRegression_California_House/venv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LI:/Python_E2EML/E2EML_LinearRegression_California_House/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='I:/Python_E2EML/E2EML_LinearRegression_California_House/venv\Library\lib\tclstub86.lib'
